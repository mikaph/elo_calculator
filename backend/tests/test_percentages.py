import random
from backend.src.elocalculator import Player, set_new_elos
...
if __name__ == "__main__":
    ...
    player_list = [Player(name="Matti", elo=100, skill=10), Player(name="Kalle", elo=100, skill=43),
                   Player(name="Seppo", elo=100, skill=74),
                   Player(name="Juhani", elo=100, skill=23),
                   ...
                   Player(name="hjjytj", elo=100, skill=23),
                   Player(name="sefsd", elo=100, skill=63),
                   Player(name="jtrbb", elo=100, skill=73),
                   Player(name="sefseree", elo=100, skill=64),
